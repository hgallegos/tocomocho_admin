...
class ReseniaController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Crear nueva Rese&ntilde;a",
                ...
                return [
                    ...
                    'title'=> "Crear nueva Rese&ntilde;a",
                    'content'=>'<span class="text-success">Rese&ntilde;a creada exitosamente</span>',
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Actualizar Rese&ntilde;a #".$id,
    ...
    /**
     * Delete an existing Resenia model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Resenia model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
